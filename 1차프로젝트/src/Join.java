...
public class Join {
	...
	private void initialize() {
		...
		list[2] = new ImageIcon(
				"C:\\Users\\SMHRD\\Desktop\\JAVA eclipse\\JAVA_workspace\\1차프로젝트\\src\\image\\회원등록2.png").getImage();
		list[3] = new ImageIcon(
				"C:\\Users\\SMHRD\\Desktop\\JAVA eclipse\\JAVA_workspace\\1차프로젝트\\src\\image\\회원등록1.png").getImage();
		...
		list[0] = new ImageIcon(
				"C:\\Users\\SMHRD\\Desktop\\JAVA eclipse\\JAVA_workspace\\1차프로젝트\\src\\image\\중복확인1.png").getImage();
		list[1] = new ImageIcon(
				"C:\\Users\\SMHRD\\Desktop\\JAVA eclipse\\JAVA_workspace\\1차프로젝트\\src\\image\\중복확인2.png").getImage();
		...
		txt_pw.setBounds(330, 182, 209, 27);
		panel.add(txt_pw);
