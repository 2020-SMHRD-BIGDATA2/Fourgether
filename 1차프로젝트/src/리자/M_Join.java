...
public class M_Join {
	...
	private void initialize() {
		frame = new JFrame();
		frame.setBounds(100, 100, 892, 552);
		...
		txt_id.setBounds(347, 110, 174, 33);
		panel.add(txt_id);
		...
		txt_pw.setBounds(347, 164, 209, 33);
		panel.add(txt_pw);
		...
		txt_name.setBounds(347, 220, 209, 33);
		panel.add(txt_name);
		...
		txt_idNumber.setBounds(347, 274, 209, 33);
		...
		txt_phonenumber.setBounds(347, 330, 222, 33);
		...
		txt_department.setBounds(347, 385, 233, 33);
		panel.add(txt_department);
		txt_department.setOpaque(false);
		...
		btn_apply.setBounds(418, 431, 47, 44);
		panel.add(btn_apply);
		...
		btn_DoubleCheck.setBounds(542, 109, 74, 38);
		panel.add(btn_DoubleCheck);
		
		String path = "C:\\Users\\SMHRD\\Desktop\\JAVA eclipse\\JAVA_workspace\\1차프로젝트\\src\\image\\02 관리자 회원가입.png";
