...
public class Login {
	...
	private void initialize() {
		...
		btn_Join.setBounds(235, 435, 166, 59);
		panel.add(btn_Join);
		...
		btn_nonMember.setBounds(475, 441, 159, 45);
		panel.add(btn_nonMember);
		
		
		Image img = new ImageIcon(path + "01 로그인.png").getImage();
		JLabel lbl_img = new JLabel(new ImageIcon(img.getScaledInstance(881, 512, Image.SCALE_SMOOTH)));
		lbl_img.setBounds(0, 0, 875, 513);
		...
		btn_login.setBounds(409, 322, 85, 84);
		panel.add(btn_login);
		panel.add(lbl_img);
